...
<div class="header-top">
    ...
    <nav class="top-navigation">
        ...
        <li><a href="../member/login.html">로그인/회원가입</a></li>
        <li><a href="../notice/notice.html">공지사항</a></li>
        <li><a href="../point/point.html">포인트</a></li>
        <li><a href="../Shipping_Information/shipping_Information.html">주문조회</a></li>
        <li><a href="../member/member_Registration.html">회원가입</a> </li>
        </ul>
    </nav>
    ...
    <div class="mainlogo">
    <a href="../index.html"><img src="../resource/image//수산시장.png" alt="LOGO"></a> 
    </div>
...
<nav class="navbar">
    ...
    <ul class="nav-menu">
        ...
        <div class="connect">
            ...
            <li class="nav-items">
            <div class="nav-item-header">
            <a href="../fair/fair.html" class="nav-link">박람회</a></div>
            <div class="nav-item-content">
                <ul>
                <li>일정표</li>
                <li>아쿠아팻랜드</li>
            ...
            <ul class="fish">
                <li class="nav-items">
                <div class="nav-item-header">
                <a href="../notice/notice.html" class="nav-link">공지사항</a></div>
                <div class="nav-item-content">
                <ul>
                <li>Q&A</li>
                <li>시착보상</li>
